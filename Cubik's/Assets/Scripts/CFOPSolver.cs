...
public class CFOPSolver {
	...
	public CFOPSolver() {
		...
		// Load algorithms
		TextAsset txt = (TextAsset)Resources.Load("F2L");
		f2lAlgorithms = txt.text.Split(new[] {Environment.NewLine}, StringSplitOptions.None);
		txt = (TextAsset)Resources.Load("OLL");
		ollAlgorithms = txt.text.Split(new[] {Environment.NewLine}, StringSplitOptions.None);
		txt = (TextAsset)Resources.Load("PLL");
		pllAlgorithms = txt.text.Split(new[] {Environment.NewLine}, StringSplitOptions.None);
	}
